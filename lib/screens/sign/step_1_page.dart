...
final ValueNotifier<bool?> _isDuplicateCheckedNotifier = ValueNotifier<bool?>(null);
              ...
              ClipRRect(
                ...
                child: OutlinedButton(
                    onPressed: () {
                      ...
                      _isDuplicateCheckedNotifier.value == null ? false : true;
                    },
          ...
          child: SizedBox(
            ...
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                ...
                backgroundColor:
                _isDuplicateCheckedNotifier.value == true ? mainColor : grayColor_E0,
                foregroundColor:
                _isDuplicateCheckedNotifier.value == true ? Colors.white : grayColor_9E,
              ),
            ),
          ),
        )
...
String? checkErrorText() {
  ...
  return _isDuplicateCheckedNotifier.value == null
      ? null
      : (_isDuplicateCheckedNotifier.value == true ? "* 가입 가능한 이메일입니다." : "* 가입된 이메일입니다.");
}
